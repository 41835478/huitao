...
class RecordController extends Controller{
    ...
    public function updateOrderInfo($order_list=array()){
        ...
        $sql_list[] = "insert into gw_order(status,cost,uid,taobao_nick,createdAt,created_date,order_id,num_iid,coupon_id,title,pict_url,item_url,category,promotion_url,price,volume,
                ...
                )SELECT 1,a.cost,a.uid,a.taobao_nick,a.createdAt,a.created_date,order_id,num_iid,coupon_id,title,pict_url,item_url,category,promotion_url,price,volume,
                rating,seller_id,seller_name,store_name,store_type,top,taobao_cid,gw_pid,gw_id,gw_name,sum,num,val,limited,reduce,discount,
                deal_price,start_time,end_time,url,coupon_url from
                (SELECT auction_title,uid,taobao_nick,a.createdAt,a.created_date,b.order_id,(paid_fee/auction_amount)cost,b.open_id from gw_order a LEFT JOIN gw_order_status b on a.order_id = b.order_id
    ...
    public function purchaseRecord($order_id_list=array(),$order_status=2){
       // $order_id_list = array(2945065425783222);
